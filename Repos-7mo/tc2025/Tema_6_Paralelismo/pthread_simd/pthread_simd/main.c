...
int main(int argc, const char * argv[]) {
    ...
    time_t stopExec = time(NULL);

    double parTime = difftime(stopExec, startExec);

    /* Obtener la suma */
    printf("La suma total paralela es = %d y el tiempo de ejecución es de: %f\n", total, parTime);
    ...
    // double seqTime = difftime(t_final, t_inicio);
